        ...
        {bidders.map((bid, i) => (
          <div key={i} className="flex justify-between items-center">
            <div className="flex justify-start items-center my-1 space-x-1">
              ...
              <span className="text-[#3d0c0c] font-medium text-sm">
                {bid.price} OOP
              </span>
            </div>
            ...
            bg-red-500 hover:bg-red-700 md:text-xs p-1
  ...
  return (
    <div className="flex justify-between items-center py-5 ">
      <div>
        ...
        <p className="text-sm font-light">{auction?.price}OOP</p>
      </div>
    ...
    <div className="flex justify-start items-center space-x-2 mt-2">
      ...
      {auction?.biddable && auction?.duration > Date.now() ? (
        <button
          type="button"
          className="shadow-sm shadow-black text-white
          bg-red-700 hover:bg-red-900 md:text-xs p-2.5
          rounded-sm cursor-pointer font-light"
          onClick={onPlaceBid}
        >
          Place a Bid
