...
const Chat = ({ id, group }) => {
  ...
  return (
    <div>
      <h2 className="mt-12 px-2 py-1 font-bold text-2xl italic">NBA NFT-World</h2>
      <h4 className="px-2 font-semibold text-xs">Join the Live Chat</h4>
      <div
        className="bg-[#1a0d5c] bg-opacity-50 w-full
        rounded-md p-2 sm:p-8 mt-5 shadow-md shadow-[#d32f2f]"
      >
        <div
        ...
        <form
          ...
          className="flex flex-row justify-between items-center bg-[#3d0c0c] rounded-md"
        >
          <input
...
const Message = ({ msg, owner, isOwner }) => (
  <div>
    <div className="flex justify-start items-center space-x-1 mb-2">
      <Identicon
        string={owner}
        className="h-5 w-5 object-contain bg-blue-800 rounded-full"
        size={18}
      />
      <div className="space-x-1">
        <span className="text-[#3d0c0c] font-bold">
