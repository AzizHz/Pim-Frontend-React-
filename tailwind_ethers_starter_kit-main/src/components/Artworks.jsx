...
const Auction = ({ auction, showOffer }) => {
  ...
  return (
    <div
      className="full overflow-hidden bg-blue-900 rounded-md shadow-xl 
    ...
    >
      ...
      <div
        className="shadow-lg shadow-gray-400 border-4 border-[#40398636] 
      flex flex-row justify-between items-center text-gray-300 px-2"
      >
        <div className="flex flex-col items-start py-2 px-1">
          <span>Current Bid</span>
          <div className="font-bold text-center">{auction.price} OOP</div>
        </div>
        <div className="flex flex-col items-start py-2 px-1">
      ...
      {showOffer ? (
        auction.live && Date.now() < auction.duration ? (
          <button
            className="bg-red-700 w-full h-[40px] p-2 text-center
            font-bold font-mono"
            onClick={onOffer}
          >
            Auction Live
          ...
          <div className="flex justify-start">
            <button
              className="bg-orange-600 w-full h-[40px] p-2 text-center
              font-bold font-mono"
              onClick={onOffer}
            >
              Offer
            ...
            <button
              className="bg-red-600 w-full h-[40px] p-2 text-center
              font-bold font-mono"
              onClick={onEdit}
            >
              Change
