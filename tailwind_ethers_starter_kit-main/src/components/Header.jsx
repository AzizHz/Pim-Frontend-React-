    ...
    <nav className="w-4/5 flex flex-row md:justify-center justify-between items-center py-4 mx-auto">
      <div className="md:flex-[0.5] flex-initial justify-center items-center">
        <Link to="/" className="text-white">
          <span className="px-2 py-1 font-bold text-3xl italic">Alley Oop</span>
          <span className="py-1 font-semibold italic">Auction</span>
        </Link>
      </div>
      ...
      {connectedAccount ? (
        <button
          ...
          bg-orange-500 hover:bg-orange-700 md:text-xs p-2
