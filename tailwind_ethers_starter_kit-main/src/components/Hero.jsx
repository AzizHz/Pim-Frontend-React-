...
const Bidder = () => (
  <div
    className="w-full text-white overflow-hidden bg-orange-800 rounded-md shadow-xl 
    shadow-black md:w-3/5 lg:w-2/5 md:mt-0 font-sans"
  >
    <img src={picture6} alt="nft" className="object-cover w-full h-full" />
    <div
    ...
    >
      <div className="p-2">
        Current Bid
        <div className="font-bold text-center">2.231 OOP</div>
      </div>
      <div className="p-2">
        Auction End
    ...
    <div
      className="bg-orange-700 w-full h-[40px] p-2 text-center 
    font-bold font-mono "
    >
      Place a Bid
    </div>
    ...
    >
      <div className="">
        ...
        <h1 className="font-semibold text-4xl mb-5 text-white py-1">
          and Sell
          <span className="text-orange-700 px-1">NFTs</span>.
        </h1>
        ...
        <div className="flex flew-row text-5xl mb-4">
          {!currentUser ? (
            <div className="flex justify-start items-center space-x-2">
              <button
                className="text-white text-sm p-2 bg-blue-500 rounded-sm w-auto 
            ...
            <button
              className="text-white text-sm p-2 bg-orange-700 rounded-sm w-auto 
              flex flex-row justify-center items-center shadow-md shadow-gray-700"
